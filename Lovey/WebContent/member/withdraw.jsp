...
<br><br><br><br><br><br><br><br>
    <form class="form-signin" action = "withdrawCheck.jsp" method = "post">
  <img class="mb-4" src="/photos/pow-bye.png" alt="" width="72" height="72">
  ...
  <br>
  <button class="btn btn-lg btn-primary btn-block" type="submit"  style="width:250px; margin:0 auto; background-color:#ff3478; border:none;">회원탈퇴</button>
