...
const infoList = [
  {
    ...
    desc: '연애의 프로재능러인 당신!\n쥐에 해당하는 당신은 연애의 모든 것들을 알고 있어, 쉽게 연애에 성공하는 스타일이랍니다.\n주로 포부가 크고 성격이 낙천적인 성향을 가지고 있고, 논리적이면서 두뇌회전이 매우 빠르다고 할 수 있어요.\n말재주 또한 좋아 사교성이 좋고 유쾌하지만 화려한 것을 좋아해\n허영심을 부리거나 사치를 부리기 때문에 이 점들을 주의해야 돼요.\n뛰어난 능력에 자만하는 경우도 종종 있기 때문에 겸손이 필요하답니다!\n'
  },
  {
  ...
  },
  {
    ...
    desc: '상대방과의 미래를 꿈꾸는 당신! 현실적인 연애보다는,\n미래에 대한 이상적인 연애관을 가지고 있어요.매일매일 사랑하는 사람과 보낼 미래를 생각하기 때문에,좋은 배우자의 자질이 있답니다. 또한 일적으로나 사랑으로나 야망이 커, 크게 성공할 확률이 높고 리더십이 매우 뛰어나답니다.다만 높은 이상에 비해서 현실이 자신의 마음에 들지 않으면 허세를 부리거나 사람들을 무시하는 경우가 많으니 이점들을 주의하면 좋을 것 같아요!'
  },
  {
